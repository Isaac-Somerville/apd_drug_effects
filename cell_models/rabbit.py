...
class RabbitModel(CardiacCellModel):
    def __init__(
        self,
        drug=None,
        drug_amount=None,
    ...
    def initConsts(self, perturbation=None, seed=42):
        ...
        # Initialise perturbed constants
        ...
        constants[76] = (
            ((constants[29] * constants[27]) / constants[28]) * constants[26]
        ) / constants[25]
        constants[77] = (np.exp(constants[5] / 67.3000) - 1.00000) / 7.00000
        constants[78] = (1.00000 - constants[53]) * constants[47] - 50.0000
        constants[79] = (1.00000 / constants[75]) * np.log(constants[3] / constants[73])
    ...
    def createLegends(self):
        ...
        for i in range(len(self.channel_list)):
            legend_algebraic[i - len(self.channel_list)] = (
                "proportion of "
                + self.channel_list[i]
                + " channel uninhibited (dimensionnp.less)"
            )
        ...
        legend_states[1] = "xm in component INa (dimensionnp.less)"
        legend_states[2] = "xh in component INa (dimensionnp.less)"
        legend_states[3] = "xj in component INa (dimensionnp.less)"
        ...
        legend_states[5] = "c1 in component ICaL (dimensionnp.less)"
        legend_states[6] = "c2 in component ICaL (dimensionnp.less)"
        legend_states[7] = "xi1ca in component ICaL (dimensionnp.less)"
        legend_states[8] = "xi1ba in component ICaL (dimensionnp.less)"
        legend_states[9] = "xi2ca in component ICaL (dimensionnp.less)"
        legend_states[10] = "xi2ba in component ICaL (dimensionnp.less)"
        legend_constants[12] = "gca in component ICaL (mmole_per_coulomb_cm)"
        legend_constants[13] = "pca in component ICaL (cm_per_s)"
        legend_algebraic[14] = "za in component ICaL (dimensionnp.less)"
        legend_algebraic[18] = "poinf in component ICaL (dimensionnp.less)"
        legend_algebraic[26] = "fca in component ICaL (dimensionnp.less)"
        ...
        legend_algebraic[33] = "Pr in component ICaL (dimensionnp.less)"
        legend_algebraic[38] = "Ps in component ICaL (dimensionnp.less)"
        legend_algebraic[30] = "poi in component ICaL (dimensionnp.less)"
        legend_algebraic[45] = "po in component ICaL (dimensionnp.less)"
        ...
        legend_algebraic[48] = "xkin in component IK1 (dimensionnp.less)"
        legend_states[11] = "xr in component IKr (dimensionnp.less)"
        ...
        legend_algebraic[19] = "xkrinf in component IKr (dimensionnp.less)"
        legend_algebraic[50] = "rg in component IKr (dimensionnp.less)"
        legend_states[12] = "Ca_i in component Ca (uM)"
        legend_constants[35] = "gks in component IKs (uS_per_nF)"
        legend_states[13] = "xs1 in component IKs (dimensionnp.less)"
        legend_states[14] = "xs2 in component IKs (dimensionnp.less)"
        legend_algebraic[103] = "eks in component reversal_potentials (mV)"
        legend_algebraic[5] = "xs1ss in component IKs (dimensionnp.less)"
        legend_algebraic[12] = "xs2ss in component IKs (dimensionnp.less)"
        legend_algebraic[16] = "tauxs1 in component IKs (ms)"
        legend_algebraic[20] = "tauxs2 in component IKs (ms)"
        legend_algebraic[52] = "gksx in component IKs (dimensionnp.less)"
        legend_algebraic[56] = "xitos in component Ito (nA_per_nF)"
        legend_algebraic[58] = "xitof in component Ito (nA_per_nF)"
        legend_states[15] = "xtos in component Ito (dimensionnp.less)"
        legend_states[16] = "ytos in component Ito (dimensionnp.less)"
        legend_states[17] = "xtof in component Ito (dimensionnp.less)"
        legend_states[18] = "ytof in component Ito (dimensionnp.less)"
        legend_constants[36] = "gtos in component Ito (uS_per_nF)"
        legend_constants[37] = "gtof in component Ito (uS_per_nF)"
        legend_algebraic[6] = "rt1 in component Ito (dimensionnp.less)"
        legend_algebraic[53] = "rt2 in component Ito (dimensionnp.less)"
        legend_algebraic[55] = "rt3 in component Ito (dimensionnp.less)"
        legend_algebraic[13] = "rt4 in component Ito (dimensionnp.less)"
        legend_algebraic[57] = "rt5 in component Ito (dimensionnp.less)"
        legend_algebraic[17] = "xtos_inf in component Ito (dimensionnp.less)"
        legend_algebraic[59] = "ytos_inf in component Ito (dimensionnp.less)"
        legend_algebraic[21] = "xtof_inf in component Ito (dimensionnp.less)"
        legend_algebraic[61] = "ytof_inf in component Ito (dimensionnp.less)"
        legend_algebraic[54] = "rs_inf in component Ito (dimensionnp.less)"
        ...
        legend_constants[77] = "sigma in component INaK (dimensionnp.less)"
        legend_algebraic[63] = "fNaK in component INaK (dimensionnp.less)"
        legend_states[20] = "Ca_submem in component Ca (uM)"
        legend_constants[41] = "gNaCa in component INaCa (uM_per_ms)"
        legend_algebraic[67] = "aloss in component INaCa (dimensionnp.less)"
        ...
        legend_algebraic[66] = "zw4 in component INaCa (dimensionnp.less)"
        ...
        legend_constants[49] = "gbarsr in component Irel (dimensionnp.less)"
        ...
        legend_algebraic[71] = "sparkV in component Irel (dimensionnp.less)"
        ...
        legend_algebraic[74] = "bpxs in component Ca (dimensionnp.less)"
        legend_algebraic[75] = "spxs in component Ca (dimensionnp.less)"
        legend_algebraic[76] = "mempxs in component Ca (dimensionnp.less)"
        legend_algebraic[77] = "sarpxs in component Ca (dimensionnp.less)"
        legend_algebraic[78] = "dcsib in component Ca (dimensionnp.less)"
        legend_algebraic[79] = "bpxi in component Ca (dimensionnp.less)"
        legend_algebraic[80] = "spxi in component Ca (dimensionnp.less)"
        legend_algebraic[81] = "mempxi in component Ca (dimensionnp.less)"
        legend_algebraic[82] = "sarpxi in component Ca (dimensionnp.less)"
        legend_algebraic[83] = "dciib in component Ca (dimensionnp.less)"
        ...
        legend_constants[74] = (
            "prNaK in component reversal_potentials (dimensionnp.less)"
        )
        legend_rates[0] = "d/dt V in component cell (mV)"
        legend_rates[2] = "d/dt xh in component INa (dimensionnp.less)"
        legend_rates[3] = "d/dt xj in component INa (dimensionnp.less)"
        legend_rates[1] = "d/dt xm in component INa (dimensionnp.less)"
        legend_rates[5] = "d/dt c1 in component ICaL (dimensionnp.less)"
        legend_rates[6] = "d/dt c2 in component ICaL (dimensionnp.less)"
        legend_rates[7] = "d/dt xi1ca in component ICaL (dimensionnp.less)"
        legend_rates[8] = "d/dt xi1ba in component ICaL (dimensionnp.less)"
        legend_rates[9] = "d/dt xi2ca in component ICaL (dimensionnp.less)"
        legend_rates[10] = "d/dt xi2ba in component ICaL (dimensionnp.less)"
        legend_rates[11] = "d/dt xr in component IKr (dimensionnp.less)"
        legend_rates[13] = "d/dt xs1 in component IKs (dimensionnp.less)"
        legend_rates[14] = "d/dt xs2 in component IKs (dimensionnp.less)"
        legend_rates[15] = "d/dt xtos in component Ito (dimensionnp.less)"
        legend_rates[16] = "d/dt ytos in component Ito (dimensionnp.less)"
        legend_rates[17] = "d/dt xtof in component Ito (dimensionnp.less)"
        legend_rates[18] = "d/dt ytof in component Ito (dimensionnp.less)"
    ...
    def computeAlgebraic(self, voi, states, constants):
        ...
        algebraic[1] = super().custom_piecewise(
            [
                np.less(states[0], -40.0000),
                0.135000 * np.exp((80.0000 + states[0]) / -6.80000),
                True,
                0.00000,
            ]
        )
        algebraic[8] = super().custom_piecewise(
            [
                np.less(states[0], -40.0000),
        ...
        algebraic[9] = super().custom_piecewise(
            [
                np.less(states[0], -40.0000),
        ...
        algebraic[0] = super().custom_piecewise(
            [
                np.greater(np.fabs(states[0] + 47.1300), 0.00100000),
                (0.320000 * 1.00000 * (states[0] + 47.1300))
                / (1.00000 - np.exp(-0.100000 * (states[0] + 47.1300))),
                True,
                3.20000,
            ]
        )
        algebraic[7] = 0.0800000 * np.exp(-states[0] / 11.0000)
        algebraic[5] = 1.00000 / (1.00000 + np.exp(-(states[0] - 1.50000) / 16.7000))
        algebraic[16] = super().custom_piecewise(
            [
                np.less(np.fabs(states[0] + 30.0000), 0.00100000 / 0.0687000),
                1.00000 / (7.19000e-05 / 0.148000 + 0.000131000 / 0.0687000),
                True,
                1.00000
                / (
        ...
        algebraic[4] = super().custom_piecewise(
            [
                np.greater(np.fabs(states[0] + 7.00000), 0.00100000),
                (0.00138000 * 1.00000 * (states[0] + 7.00000))
                / (1.00000 - np.exp(-0.123000 * (states[0] + 7.00000))),
                True,
                0.00138000 / 0.123000,
            ]
        )
        algebraic[11] = super().custom_piecewise(
            [
                np.greater(np.fabs(states[0] + 10.0000), 0.00100000),
                (0.000610000 * 1.00000 * (states[0] + 10.0000))
                / (np.exp(0.145000 * (states[0] + 10.0000)) - 1.00000),
                True,
                0.000610000 / 0.145000,
            ]
        )
        algebraic[15] = 1.00000 / (algebraic[4] + algebraic[11])
        algebraic[19] = 1.00000 / (1.00000 + np.exp(-(states[0] + 50.0000) / 7.50000))
        algebraic[12] = algebraic[5]
        algebraic[20] = 4.00000 * algebraic[16]
        algebraic[6] = -(states[0] + 3.00000) / 15.0000
        algebraic[17] = 1.00000 / (1.00000 + np.exp(algebraic[6]))
        algebraic[22] = 9.00000 / (1.00000 + np.exp(-algebraic[6])) + 0.500000
        algebraic[21] = algebraic[17]
        algebraic[13] = ((-states[0] / 30.0000) * states[0]) / 30.0000
        algebraic[24] = 3.50000 * np.exp(algebraic[13]) + 1.50000
        algebraic[18] = 1.00000 / (
            1.00000 + np.exp(-(states[0] - constants[14]) / constants[15])
        )
        algebraic[23] = algebraic[18] / constants[31]
        algebraic[25] = (1.00000 - algebraic[18]) / constants[31]
        algebraic[26] = 1.00000 / (
            1.00000 + np.power(constants[22] / states[4], 3.00000)
        )
        algebraic[34] = 10.0000 + 4954.00 * np.exp(states[0] / 15.6000)
        algebraic[35] = (
            constants[30] / (1.00000 + np.power(states[4] / constants[23], 4.00000))
            + 0.100000
        )
        algebraic[33] = 1.00000 - 1.00000 / (
            1.00000 + np.exp(-(states[0] - constants[18]) / constants[19])
        )
        algebraic[36] = (algebraic[34] - algebraic[35]) * algebraic[33] + algebraic[35]
        algebraic[38] = 1.00000 / (
            1.00000 + np.exp(-(states[0] - constants[20]) / constants[21])
        )
        ...
        algebraic[30] = 1.00000 / (
            1.00000 + np.exp(-(states[0] - constants[16]) / constants[17])
        )
        algebraic[31] = (1.00000 - algebraic[30]) / constants[32]
        algebraic[28] = 0.0241680 * algebraic[26]
        algebraic[43] = (
            (
                (((algebraic[31] * algebraic[23]) / algebraic[25]) * algebraic[28])
                / constants[24]
            )
            * algebraic[40]
        ) / algebraic[39]
        ...
        algebraic[44] = (
            (
                (((algebraic[32] * algebraic[23]) / algebraic[25]) * constants[25])
                / constants[26]
            )
            * algebraic[42]
        ) / algebraic[41]
        algebraic[45] = (
            ((((1.00000 - states[7]) - states[9]) - states[8]) - states[10]) - states[5]
        ) - states[6]
        algebraic[27] = 0.0182688 * algebraic[26]
        algebraic[29] = (
            ((algebraic[27] * constants[27]) / constants[28]) * constants[24]
        ) / algebraic[28]
        algebraic[53] = (states[0] + 33.5000) / 10.0000
        algebraic[59] = 1.00000 / (1.00000 + np.exp(algebraic[53]))
        algebraic[55] = (states[0] + 60.0000) / 10.0000
        algebraic[62] = 3000.00 / (1.00000 + np.exp(algebraic[55])) + 30.0000
        algebraic[61] = algebraic[59]
        algebraic[57] = (states[0] + 33.5000) / 10.0000
        algebraic[64] = 20.0000 / (1.00000 + np.exp(algebraic[57])) + 20.0000
        algebraic[72] = (constants[58] * states[12] * states[12]) / (
            states[12] * states[12] + constants[56] * constants[56]
        )
        algebraic[73] = (
            (constants[59] * states[21] * states[21])
            / (states[21] * states[21] + constants[57] * constants[57])
        ) * (states[21] * 16.6670 - states[12])
        algebraic[79] = (constants[60] * constants[61]) / (
            (constants[61] + states[12]) * (constants[61] + states[12])
        )
        algebraic[80] = (constants[62] * constants[63]) / (
            (constants[63] + states[12]) * (constants[63] + states[12])
        )
        algebraic[81] = (constants[64] * constants[65]) / (
            (constants[65] + states[12]) * (constants[65] + states[12])
        )
        algebraic[82] = (constants[66] * constants[67]) / (
            (constants[67] + states[12]) * (constants[67] + states[12])
        )
        algebraic[83] = 1.00000 / (
            1.00000 + algebraic[79] + algebraic[80] + algebraic[81] + algebraic[82]
        )
        algebraic[86] = (
            constants[68] * states[12] * (constants[70] - states[24])
            - constants[69] * states[24]
        )
        algebraic[84] = (states[20] - states[12]) / constants[71]
        algebraic[85] = (
            constants[68] * states[20] * (constants[70] - states[25])
            - constants[69] * states[25]
        )
        algebraic[87] = (-states[23] + algebraic[72]) - algebraic[73]
        algebraic[69] = super().custom_piecewise(
            [
                np.greater(states[22], 50.0000) & np.less(states[22], constants[47]),
                (states[22] - 50.0000) / 1.00000,
                np.greater_equal(states[22], constants[47]),
                constants[53] * states[22] + constants[78],
                True,
                0.00000,
            ]
        )
        ...
        algebraic[89] = super().custom_piecewise(
            [
                np.less(np.fabs(algebraic[14]), 0.00100000),
                (
                    4.00000
                    * constants[13]
                    * constants[2]
                    * constants[75]
                    * (algebraic[88] * np.exp(algebraic[14]) - 0.341000 * constants[4])
                )
                / (2.00000 * constants[75]),
                True,
                (
                    4.00000
                    * constants[13]
                ...
                / (np.exp(algebraic[14]) - 1.00000),
            ]
        )
        algebraic[71] = np.exp(-constants[52] * (states[0] + 30.0000)) / (
            1.00000 + np.exp(-constants[52] * (states[0] + 30.0000))
        )
        algebraic[91] = (
            (constants[48] / 1.00000)
            * algebraic[45]
            * np.fabs(algebraic[89])
            * algebraic[71]
        )
        algebraic[92] = (
            (
                (algebraic[45] * algebraic[70] * np.fabs(algebraic[89]) * constants[49])
                / 1.00000
            )
            * np.exp(-constants[51] * (states[0] + 30.0000))
        ) / (1.00000 + np.exp(-constants[51] * (states[0] + 30.0000)))
        algebraic[94] = algebraic[45] * constants[50] * np.fabs(algebraic[89])
        algebraic[96] = algebraic[92] + algebraic[94]
        algebraic[90] = constants[12] * algebraic[45] * algebraic[89]
        algebraic[67] = 1.00000 / (
            1.00000 + np.power(constants[42] / states[20], 3.00000)
        )
        algebraic[95] = (np.power(states[19], 3.00000)) * constants[4] * np.exp(
            states[0] * 0.350000 * constants[75]
        ) - (np.power(constants[5], 3.00000)) * algebraic[88] * np.exp(
            states[0] * (0.350000 - 1.00000) * constants[75]
        )
        algebraic[66] = 1.00000 + 0.200000 * np.exp(
            states[0] * (0.350000 - 1.00000) * constants[75]
        )
        algebraic[97] = (
            constants[43] * (np.power(states[19], 3.00000))
            + (np.power(constants[44], 3.00000)) * algebraic[88]
        )
        algebraic[98] = (
            (np.power(constants[45], 3.00000))
            * constants[4]
            * (1.00000 + algebraic[88] / constants[46])
        )
        algebraic[68] = (
            constants[46]
            * (np.power(constants[5], 3.00000))
            * (1.00000 + np.power(states[19] / constants[45], 3.00000))
        )
        algebraic[99] = (np.power(states[19], 3.00000)) * constants[4] + (
            np.power(constants[5], 3.00000)
        ) * algebraic[88]
        algebraic[100] = algebraic[97] + algebraic[98] + algebraic[68] + algebraic[99]
        algebraic[101] = (constants[41] * algebraic[67] * algebraic[95]) / (
            algebraic[66] * algebraic[100]
        )
        algebraic[74] = (constants[60] * constants[61]) / (
            (constants[61] + states[20]) * (constants[61] + states[20])
        )
        algebraic[75] = (constants[62] * constants[63]) / (
            (constants[63] + states[20]) * (constants[63] + states[20])
        )
        algebraic[76] = (constants[64] * constants[65]) / (
            (constants[65] + states[20]) * (constants[65] + states[20])
        )
        algebraic[77] = (constants[66] * constants[67]) / (
            (constants[67] + states[20]) * (constants[67] + states[20])
        )
        algebraic[78] = 1.00000 / (
            1.00000 + algebraic[74] + algebraic[75] + algebraic[76] + algebraic[77]
        )
        algebraic[63] = 1.00000 / (
            1.00000
            + 0.124500 * np.exp(-0.100000 * states[0] * constants[75])
            + 0.0365000 * constants[77] * np.exp(-states[0] * constants[75])
        )
        algebraic[65] = (
            (
                (constants[38] * algebraic[63] * states[19])
                / (states[19] + constants[40])
            )
            * constants[3]
        ) / (constants[3] + constants[39])
        algebraic[102] = constants[6] * algebraic[101]
        algebraic[105] = (1.00000 / constants[75]) * np.log(constants[5] / states[19])
        algebraic[106] = (
            algebraic[-3]
            * constants[11]
            * states[2]
            ...
            * states[1]
            * states[1]
            * (states[0] - algebraic[105])
        )
        algebraic[46] = 1.02000 / (
            1.00000 + np.exp(0.238500 * ((states[0] - constants[79]) - 59.2150))
        )
        algebraic[47] = (
            0.491240 * np.exp(0.0803200 * ((states[0] - constants[79]) + 5.47600))
            + 1.00000 * np.exp(0.0617500 * ((states[0] - constants[79]) - 594.310))
        ) / (1.00000 + np.exp(-0.514300 * ((states[0] - constants[79]) + 4.75300)))
        algebraic[48] = algebraic[46] / (algebraic[46] + algebraic[47])
        algebraic[49] = (
            algebraic[-5]
            * constants[33]
            * (np.power(constants[3] / 5.40000, 1.0 / 2))
            * algebraic[48]
            * (states[0] - constants[79])
        )
        algebraic[54] = 1.00000 / (1.00000 + np.exp(algebraic[53]))
        algebraic[56] = (
            constants[36]
            * states[15]
            * (states[16] + 0.500000 * algebraic[54])
            * (states[0] - constants[79])
        )
        algebraic[58] = (
            algebraic[-2]
        ...
        algebraic[93] = algebraic[-6] * 2.00000 * constants[6] * algebraic[90]
        algebraic[50] = 1.00000 / (1.00000 + np.exp((states[0] + 33.0000) / 22.4000))
        algebraic[51] = (
            algebraic[-1]
            * constants[34]
            * (np.power(constants[3] / 5.40000, 1.0 / 2))
        ...
        algebraic[103] = (1.00000 / constants[75]) * np.log(
            (constants[3] + constants[74] * constants[5])
            / (constants[73] + constants[74] * states[19])
        )
        algebraic[52] = 1.00000 + 0.800000 / (
            1.00000 + np.power(0.500000 / states[12], 3.00000)
        )
        algebraic[104] = (
            algebraic[-4]
            * constants[35]
            ...
            * states[13]
            * states[14]
            * (states[0] - algebraic[103])
        )
        algebraic[3] = np.floor(voi / constants[8]) * constants[8]
        algebraic[10] = super().custom_piecewise(
            [
                np.greater_equal(voi - algebraic[3], constants[7])
                & np.less_equal(voi - algebraic[3], constants[7] + constants[9]),
                constants[10],
                True,
                0.00000,
            ]
...
def njitComputeRates(
    ...
    algebraic[8] = (
        ...
        + 310000.0 * np.exp(0.350000 * states[0])
        if states[0] < -40.0
        else 1.00000 / (0.130000 * (1.00000 + np.exp((states[0] + 10.6600) / -11.1000)))
    )
    ...
    algebraic[9] = (
        ...
        / (1.00000 + np.exp(-0.137800 * (states[0] + 40.1400)))
        if states[0] < -40.0
        else (0.300000 * np.exp(-2.53500e-07 * states[0]))
        / (1.00000 + np.exp(-0.100000 * (states[0] + 32.0000)))
    )
    ...
    algebraic[0] = (
        (0.320000 * 1.00000 * (states[0] + 47.1300))
        / (1.00000 - np.exp(-0.100000 * (states[0] + 47.1300)))
        if np.fabs(states[0] + 47.1300) > 0.001
        else 3.20000
    )
    algebraic[7] = 0.0800000 * np.exp(-states[0] / 11.0000)
    ...
    algebraic[16] = (
        1.00000 / (7.19000e-05 / 0.148000 + 0.000131000 / 0.0687000)
        if np.fabs(states[0] + 30.0000) < 0.00100000 / 0.0687000
        else 1.00000
        / (
            (7.19000e-05 * (states[0] + 30.0000))
            / (1.00000 - np.exp(-0.148000 * (states[0] + 30.0000)))
    ...
    algebraic[4] = (
        (0.00138000 * 1.00000 * (states[0] + 7.00000))
        / (1.00000 - np.exp(-0.123000 * (states[0] + 7.00000)))
        if np.fabs(states[0] + 7.00000) > 0.00100000
        else 0.00138000 / 0.123000
    )
    algebraic[11] = (
        (0.000610000 * 1.00000 * (states[0] + 10.0000))
        / (np.exp(0.145000 * (states[0] + 10.0000)) - 1.00000)
        if np.fabs(states[0] + 10.0000) > 0.00100000
        else 0.000610000 / 0.145000
    )
    algebraic[15] = 1.00000 / (algebraic[4] + algebraic[11])
    algebraic[19] = 1.00000 / (1.00000 + np.exp(-(states[0] + 50.0000) / 7.50000))
    ...
    algebraic[23] = algebraic[18] / constants[31]
    algebraic[25] = (1.00000 - algebraic[18]) / constants[31]
    algebraic[26] = 1.00000 / (1.00000 + np.power(constants[22] / states[4], 3.00000))
    algebraic[34] = 10.0000 + 4954.00 * np.exp(states[0] / 15.6000)
    algebraic[35] = (
        constants[30] / (1.00000 + np.power(states[4] / constants[23], 4.00000))
        + 0.100000
    ...
    algebraic[42] = (1.00000 - algebraic[38]) / algebraic[37]
    rates[6] = (
        algebraic[25] * states[5]
        + algebraic[40] * states[9]
        + algebraic[42] * states[10]
    ) - (algebraic[39] + algebraic[41] + algebraic[23]) * states[6]
    algebraic[30] = 1.00000 / (
        1.00000 + np.exp(-(states[0] - constants[16]) / constants[17])
    )
    algebraic[31] = (1.00000 - algebraic[30]) / constants[32]
    ...
    rates[9] = (algebraic[31] * states[7] + algebraic[39] * states[6]) - (
        algebraic[40] + algebraic[43]
    ) * states[9]
    algebraic[32] = algebraic[31]
    algebraic[44] = (
        (
    ...
    rates[10] = (algebraic[32] * states[8] + algebraic[41] * states[6]) - (
        algebraic[42] + algebraic[44]
    ) * states[10]
    algebraic[45] = (
        ((((1.00000 - states[7]) - states[9]) - states[8]) - states[10]) - states[5]
    ) - states[6]
    rates[5] = (
        algebraic[23] * states[6]
        + constants[24] * states[7]
        + constants[26] * states[8]
        + constants[28] * algebraic[45]
    ) - (algebraic[25] + constants[27] + constants[25] + algebraic[28]) * states[5]
    algebraic[27] = 0.0182688 * algebraic[26]
    algebraic[29] = (
        ((algebraic[27] * constants[27]) / constants[28]) * constants[24]
    ) / algebraic[28]
    rates[7] = (
        algebraic[28] * states[5]
        + algebraic[43] * states[9]
        + algebraic[27] * algebraic[45]
    ) - (algebraic[31] + constants[24] + algebraic[29]) * states[7]
    rates[8] = (
        constants[25] * states[5]
        + algebraic[44] * states[10]
        + constants[29] * algebraic[45]
    ) - (algebraic[32] + constants[26] + constants[76]) * states[8]
    algebraic[53] = (states[0] + 33.5000) / 10.0000
    algebraic[59] = 1.00000 / (1.00000 + np.exp(algebraic[53]))
    algebraic[55] = (states[0] + 60.0000) / 10.0000
    algebraic[62] = 3000.00 / (1.00000 + np.exp(algebraic[55])) + 30.0000
    ...
    algebraic[84] = (states[20] - states[12]) / constants[71]
    rates[12] = algebraic[83] * (
        ((algebraic[84] - algebraic[72]) + algebraic[73]) - algebraic[86]
    )
    ...
    algebraic[69] = (
        0.00000
        if states[22] <= 50.0
        else (states[22] - 50.0000) / 1.00000
        if states[22] < constants[47]
        else constants[53] * states[22] + constants[78]
    )
    algebraic[70] = (states[21] * algebraic[69]) / constants[47]
    algebraic[88] = states[20] / 1000.00
    algebraic[14] = states[0] * 2.00000 * constants[75]
    ...
    rates[23] = (
        algebraic[91] * algebraic[70]
        - (states[23] * (1.00000 - (constants[55] * algebraic[87]) / states[21]))
        / constants[55]
    )
    algebraic[92] = (
        (
    ...
    algebraic[90] = constants[12] * algebraic[45] * algebraic[89]
    algebraic[67] = 1.00000 / (1.00000 + np.power(constants[42] / states[20], 3.00000))
    algebraic[95] = (np.power(states[19], 3.00000)) * constants[4] * np.exp(
        states[0] * 0.350000 * constants[75]
    ) - (np.power(constants[5], 3.00000)) * algebraic[88] * np.exp(
        states[0] * (0.350000 - 1.00000) * constants[75]
    ...
    rates[20] = algebraic[78] * (
        50.0000 * (((states[23] - algebraic[84]) - algebraic[90]) + algebraic[101])
        - algebraic[85]
    )
    algebraic[63] = 1.00000 / (
        1.00000
    ...
    algebraic[65] = (
        ((constants[38] * algebraic[63] * states[19]) / (states[19] + constants[40]))
        * constants[3]
    ) / (constants[3] + constants[39])
    algebraic[102] = constants[6] * algebraic[101]
    algebraic[105] = (1.00000 / constants[75]) * np.log(constants[5] / states[19])
    ...
    rates[19] = -(
        algebraic[106] + 3.00000 * algebraic[65] + 3.00000 * algebraic[102]
    ) / (constants[6] * 1000.00)
    algebraic[46] = 1.02000 / (
        1.00000 + np.exp(0.238500 * ((states[0] - constants[79]) - 59.2150))
    )
    ...
    algebraic[10] = (
        constants[10]
        if (voi - algebraic[3] >= constants[7])
        and (voi - algebraic[3] <= constants[7] + constants[9])
        else 0.00000
    )
    algebraic[107] = -(
        algebraic[106]
